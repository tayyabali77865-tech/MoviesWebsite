...
async function run() {
    // Test filtering by genre on the list endpoint
    await testEndpoint('/movie-or-tv/list?category=movie&genre=Action');
    await testEndpoint('/movie-or-tv/list?category=movie&genre=1'); // Some APIs use numeric IDs
}
